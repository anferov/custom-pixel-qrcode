...
use Anferov\QrCode\Choreography;
use Anferov\QrCode\CodeChoreographer;
...
$imageRendererA = new ImageCodeRenderer(new CodeFrame("http://www.coca-cola.com"),
    new ImageRendererConfig('small-circle-24'));
...
$imageRendererB = new ImageCodeRenderer(new CodeFrame("http://php.dzienia.pl/custom-pixel-qrcode/demo/demo_stage.php"),
    new ImageRendererConfig('bordered-24'));
