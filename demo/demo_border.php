...
<div style="width:1050px; height:380px;overflow:auto;border:1px solid silver;position: relative; left: 0; top: 0; background-color:gray">
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_A_' . $fileName; ?>"
         style="width:300px;position:absolute;top:40;left:40;z-index:100"/>
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_B_' . $fileName; ?>"
         style="width:300px;position:absolute;top:40;left:370;z-index:100"/>
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_C_' . $fileName; ?>"
         style="width:300px;position:absolute;top:40;left:700;z-index:100"/>
</div>
<br/><br/><br/>
