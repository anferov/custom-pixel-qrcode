...
namespace Anferov\QrCode\Reader\Common;
 ...
 * a good general purpose binarizer for uses outside Anferov\QrCode\Reader.
 *
...
final class HybridBinarizer extends GlobalHistogramBinarizer
{
    ...
    public function getBlackMatrix()
    {
        ...
        if ($width >= self::$MINIMUM_DIMENSION && $height >= self::$MINIMUM_DIMENSION) {
            ...
            self::calculateThresholdForBlock($luminances, $subWidth, $subHeight, $width, $height, $blackPoints,
                $newMatrix);
     ...
     *  http://groups.google.com/group/Anferov\QrCode\Reader/browse_thread/thread/d06efa2c35a7ddc0
     */
