...
namespace Anferov\QrCode\Reader\Qrcode;

use Anferov\QrCode\Reader\BinaryBitmap;
use Anferov\QrCode\Reader\ChecksumException;
use Anferov\QrCode\Reader\Common\BitMatrix;
use Anferov\QrCode\Reader\FormatException;
use Anferov\QrCode\Reader\NotFoundException;
use Anferov\QrCode\Reader\Qrcode\Decoder\Decoder;
use Anferov\QrCode\Reader\Qrcode\Detector\Detector;
use Anferov\QrCode\Reader\Reader;
use Anferov\QrCode\Reader\Result;
...
class QRCodeReader implements Reader
{
     ...
     *
     * @return Result
     * @throws \Anferov\QrCode\Reader\FormatException
     * @throws \Anferov\QrCode\Reader\NotFoundException
     */
     ...
     * case.
     *
     * @see com.google.Anferov\QrCode\Reader.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
     */
