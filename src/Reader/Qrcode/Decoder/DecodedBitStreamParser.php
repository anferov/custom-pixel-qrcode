...
use Anferov\QrCode\Reader\Common\BitSource;
use Anferov\QrCode\Reader\Common\CharacterSetECI;
use Anferov\QrCode\Reader\Common\DecoderResult;
use Anferov\QrCode\Reader\Common\StringUtils;
                                ...
                                if ($mode == Mode::$HANZI) {
                                    ...
                                    if ($mode == Mode::$NUMERIC) {
                                        ...
                                        if ($mode == Mode::$ALPHANUMERIC) {
                                            ...
                                            if ($mode == Mode::$BYTE) {
                                                self::decodeByteSegment($bits, $result, $count, $currentCharacterSetECI,
                                                    $byteSegments, $hints);
                                            } else {
                                                if ($mode == Mode::$KANJI) {
