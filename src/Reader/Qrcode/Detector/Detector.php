...
use Anferov\QrCode\Reader\Common\Detector\MathUtils;
use Anferov\QrCode\Reader\Common\DetectorResult;
use Anferov\QrCode\Reader\Common\GridSampler;
use Anferov\QrCode\Reader\Common\PerspectiveTransform;
use Anferov\QrCode\Reader\DecodeHintType;
...
use Anferov\QrCode\Reader\ResultPointCallback;
...
class Detector
{
    ...
    protected final function processFinderPatternInfo($info)
    {
        ...
        $provisionalVersion = \Anferov\QrCode\Reader\Qrcode\Decoder\Version::getProvisionalVersionForDimension($dimension);
...
// Now count other way -- don't run off image though of course
        ...
        if ($otherToY < 0) {
            ...
            if ($otherToY >= $this->image->getHeight()) {
