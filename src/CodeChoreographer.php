...
class CodeChoreographer extends CodeRenderer
{
     ...
     * @return \Anferov\QrCode\CodeChoreographer itself, for method chaining
     */
    ...
    public function render()
    {
        ...
        \imagecopy($this->rendered, $this->backgroundImage, $this->globalOffset[0], $this->globalOffset[1], 0, 0,
            $this->backgroundDim[0], $this->backgroundDim[1]);
        \imagealphablending($this->rendered, true);
        \imagecopyresampled($this->rendered, $this->renderer->rendered, $this->globalOffset[0] + $this->codeOffset[0],
            $this->globalOffset[1] + $this->codeOffset[1], 0, 0, $this->codeDim, $this->codeDim, $this->codeOrigDim,
            $this->codeOrigDim);
        \imagealphablending($this->rendered, false);
